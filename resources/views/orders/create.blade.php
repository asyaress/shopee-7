...
@section('title', 'Tambah Pesanan - Toedjoe Order System')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="order_number"
                                        ...
                                        value="{{ old('order_number') }}" placeholder="Contoh: TSG-2025-001" required>
                                    @error('order_number')
                            ...
                            <div class="row">
                                    ...
                                    <div class="d-flex gap-2">
                                        <div class="flex-grow-1">
                                            <select name="customer_id" id="customer_id"
                                                class="hub-form-control select2-customer @error('customer_id') is-invalid @enderror"
                                                required>
                                                <option value="">Pilih Customer</option>
                                                @foreach($customers->sortBy('name') as $customer)
                                                    <option value="{{ $customer->id }}" {{ old('customer_id') == $customer->id ? 'selected' : '' }} data-name="{{ $customer->name }}"
                                                        data-company="{{ $customer->company }}"
                                                        data-phone="{{ $customer->phone }}">
                                                        {{ $customer->name }}@if($customer->company) -
                                                        {{ $customer->company }}@endif
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="completion_date"
                                        ...
                                        value="{{ old('completion_date', date('Y-m-d', strtotime('+0 days'))) }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="jenis_pengiriman" id="jenis_pengiriman"
                                    class="hub-form-control select2-shipping @error('jenis_pengiriman') is-invalid @enderror"
                                    required>
                                    <option value="">Pilih Jenis Pengiriman</option>
                                    <option value="Ambil di Tempat" {{ old('jenis_pengiriman') == 'Ambil di Tempat' ? 'selected' : '' }}>Ambil di Tempat</option>
                                    <option value="Anter Aja" {{ old('jenis_pengiriman') == 'Anter Aja' ? 'selected' : '' }}>
                                        Anter Aja</option>
                                    <option value="Gosend" {{ old('jenis_pengiriman') == 'Gosend' ? 'selected' : '' }}>Gosend
                                    </option>
                                    <option value="JNE" {{ old('jenis_pengiriman') == 'JNE' ? 'selected' : '' }}>JNE</option>
                                    <option value="JTR" {{ old('jenis_pengiriman') == 'JTR' ? 'selected' : '' }}>JTR</option>
                                    <option value="POS" {{ old('jenis_pengiriman') == 'POS' ? 'selected' : '' }}>POS</option>
                                    <option value="SPX" {{ old('jenis_pengiriman') == 'SPX' ? 'selected' : '' }}>SPX</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="jenis_transaksi" id="jenis_transaksi"
                                    class="hub-form-control select2-transaction @error('jenis_transaksi') is-invalid @enderror"
                                    required>
                                    <option value="">Pilih Jenis Transaksi</option>
                                    <option value="Shopee" {{ old('jenis_transaksi') == 'Shopee' ? 'selected' : '' }}>Shopee
                                    </option>
                                    <option value="Website" {{ old('jenis_transaksi') == 'Website' ? 'selected' : '' }}>
                                        Website</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="notes"
                                    class="hub-form-control @error('notes') is-invalid @enderror" rows="3"
    ...
    <script>
        ...
        const productOptions = [
            @foreach($products->sortBy('name') as $product)
                    ...
                    unit: '{{ $product->unit }}',
                    display: '{{ $product->name }} - {{ $product->category }}@if($product->base_price) (Rp {{ number_format($product->base_price, 0, ',', '.') }})@endif'
                },
            @endforeach
            ];
