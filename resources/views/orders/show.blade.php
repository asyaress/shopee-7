...
@section('title', 'Detail Pesanan — Shopee Profit Hub')
...
<div class="report-shell order-detail-page">
    ...
    <div class="row g-3 g-lg-4">
            ...
            <div class="col-12 col-lg-8 order-2 order-lg-1">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="info-group">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-value">
                                            {{ $order->completion_date->format('d F Y') }}
                                            @php
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-value">{{ $order->duration }} hari</div>
                                    </div>
                                    <div class="info-item">
                                        <label class="info-label">Jenis Pengiriman:</label>
                                        <div class="info-value">{{ $order->jenis_pengiriman ?? '-' }}</div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body p-3 p-md-4">
                        <div class="customer-info">
                            ...
                            <div class="customer-details">
                                <h6 class="customer-name mb-1">{{ $order->customer_name }}</h6>
                                @if($order->customer_company)
                                    <p class="customer-company text-muted mb-2">{{ $order->customer_company }}</p>
                                @endif
                                @if($order->customer_type)
                                    <span class="badge badge-customer-type {{ $order->customer_type == 'company' ? 'bg-info' : 'bg-secondary' }} mb-2">
                                        {{ $order->customer_type == 'company' ? 'Perusahaan' : 'Individual' }}
                                    </span>
                                @endif
                                <div class="customer-contact">
                                    @if($order->customer_phone)
                                        <div class="contact-item">
                                            ...
                                            <a href="tel:{{ $order->customer_phone }}" class="contact-link">
                                    ...
                                    @if($order->customer_email)
                                        <div class="contact-item">
                                            ...
                                            <a href="mailto:{{ $order->customer_email }}" class="contact-link">
                                    ...
                                    @if($order->customer_address)
                                        <div class="contact-item">
                                            ...
                                            <span class="contact-text" title="{{ $order->customer_address }}">
                                                {{ Str::limit($order->customer_address, 100) }}
                                            </span>
                                        </div>
                                    @endif
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span class="badge bg-light text-dark">
                                                    {{ $item->quantity }} {{ optional($item->product)->unit ?? 'pcs' }}
                                                </span>
                                            </td>
                ...
                @if($order->notes)
                    <div class="hub-card mb-3 mb-md-4">
                        ...
                        <div class="card-body p-3 p-md-4">
                            <p class="mb-0 notes-text">{{ $order->notes }}</p>
                        </div>
                    </div>
                @endif
            </div>
            ...
            <div class="col-12 col-lg-4 order-1 order-lg-2">
                {{-- ✅ Wrapper putih agar Timeline + Aksi Cepat "kena container utama" --}}
                <div class="right-panel">
                    {{-- Price Summary Card - FOKUS UTAMA --}}
                            ...
                            @if($order->total_amount)
                                ...
                                <div class="price-summary-section mb-3">
                                    <div class="summary-row">
                                        ...
                                        <span class="summary-value">{{ $order->orderItems->sum('quantity') }} pcs</span>
                                    </div>
                                </div>
                                ...
                                {{-- Shopee Financial Details - BAGIAN UTAMA --}}
                                @if(($order->jenis_transaksi ?? '') === 'Shopee' && $order->shopeeFinancial)
                                    @php
                                        try {
                                            ...
                                            <div class="financial-section mb-3">
                                                <div class="financial-row">
                                                    ...
                                                    <span class="financial-value">
                                                        Rp {{ number_format($subtotalPesanan, 0, ',', '.') }}
                                                    </span>
                                                </div>
                                                <div class="financial-row">
                                            ...
                                            <div class="financial-section financial-section-fees mb-3">
                                                ...
                                                <div class="financial-row financial-row-total-fees">
                                                    ...
                                                    <span class="financial-value fw-bold text-danger">
                                                        - Rp {{ number_format($biayaLainnya, 0, ',', '.') }}
                                                    </span>
                                                </div>
                                                ...
                                                <div class="fees-details">
                                                    ...
                                                    @endif
                                                    @if($biayaProgramHemat > 0)
                                                        <div class="financial-row financial-row-sm">
                                                            <span class="financial-label">Biaya Program Hemat</span>
                                                            <span class="financial-value text-danger">
                                                                - Rp {{ number_format($biayaProgramHemat, 0, ',', '.') }}
                                                            </span>
                                                        </div>
                                                    @endif
                                                    @if($biayaLayanan > 0)
                                                    ...
                                                    @if($biayaProses > 0)
                                                        <div class="financial-row financial-row-sm">
                                                            ...
                                                            <span class="financial-value text-danger">
                                                                - Rp {{ number_format($biayaProses, 0, ',', '.') }}
                                                            </span>
                                                        </div>
                                                    @endif
                                                </div>
                                            ...
                                            <div class="shopee-raw-data mt-3">
                                                <details class="raw-data-details">
                                                    ...
                                                    <div class="raw-data-content">
                                                        <pre class="raw-data-pre">{{ json_encode($raw, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) }}</pre>
                                                        @if($biayaPembayaranPembeli > 0)
                                                            <div class="alert alert-info alert-sm mt-2 mb-0">
                                                                <small>
                                                                    <strong>Catatan:</strong> Biaya pembayaran (Rp {{ number_format($biayaPembayaranPembeli, 0, ',', '.') }})
                    ...
                    <div class="hub-card mb-3 mb-md-4">
                        ...
                        <div class="card-body p-3 p-md-4">
                            <div class="timeline">
                                ...
                                <div class="timeline-item {{ $order->status == 'in_progress' ? 'active' : ($order->status == 'completed' ? 'completed' : '') }}">
                                    <div class="timeline-marker"></div>
                                    <div class="timeline-content">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        <small class="timeline-date">
                                            @if($order->status == 'completed')
                                                Selesai
                                            @else
                                                Target: {{ $order->completion_date->format('d M Y') }}
                                            @endif
                                        </small>
                                    </div>
                                </div>
                    ...
                    <div class="hub-card mb-0">
                        ...
                        <div class="card-body p-3 p-md-4">
                            <div class="d-grid gap-2">
                                ...
                                @if($order->customer_phone)
                                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $order->customer_phone) }}?text=Halo%20{{ urlencode($order->customer_name) }},%20mengenai%20pesanan%20{{ urlencode($order->order_number) }}"
                                       target="_blank"
                                ...
                                <a href="{{ route('orders.create') }}?duplicate={{ $order->id }}"
