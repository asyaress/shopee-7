...
@section('title', 'Tambah Produk - Toedjoe Order System')
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="unit" class="hub-form-control @error('unit') is-invalid @enderror" required>
                                    ...
                                    <option value="m2" {{ old('unit') == 'm2' ? 'selected' : '' }}>M² (Meter Persegi)</option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description"
                                      ...
                                      rows="4"
                                      placeholder="Deskripsikan produk ini, termasuk bahan, ukuran, atau spesifikasi lainnya...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="specifications"
                                      ...
                                      rows="3"
                                      placeholder="Contoh: Bahan art paper 120gsm, ukuran A4, finishing glossy/matt...">{{ old('specifications') }}</textarea>
