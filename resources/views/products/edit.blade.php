...
@section('title', 'Edit Produk - Toedjoe Order System')
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="unit" class="hub-form-control @error('unit') is-invalid @enderror" required>
                                    ...
                                    <option value="m2" {{ old('unit', $product->unit) == 'm2' ? 'selected' : '' }}>M² (Meter Persegi)</option>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <select name="category" id="categorySelect" class="hub-form-control @error('category') is-invalid @enderror">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="base_price"
                                           class="hub-form-control @error('base_price') is-invalid @enderror"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description"
                                      class="hub-form-control @error('description') is-invalid @enderror"
                                      rows="4"
                                      placeholder="Deskripsikan produk ini, termasuk bahan, ukuran, atau spesifikasi lainnya...">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="specifications"
                                      class="hub-form-control @error('specifications') is-invalid @enderror"
                                      rows="3"
                                      placeholder="Contoh: Bahan art paper 120gsm, ukuran A4, finishing glossy/matt...">{{ old('specifications', $product->specifications) }}</textarea>
            ...
            <div class="col-lg-4">
                ...
                <div class="hub-card mb-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        <h5 id="previewName" class="mb-1">{{ $product->name }}</h5>
                        <p id="previewCategory" class="text-muted mb-2" style="{{ $product->category ? '' : 'display: none;' }}">
                            <span class="badge bg-info" id="categoryBadge">{{ $product->category }}</span>
                        </p>
                        <div id="previewPrice" class="mb-3">
                            <div class="fw-bold" style="color: var(--primary-red);">
                                Rp {{ number_format($product->base_price, 0, ',', '.') }}
                            </div>
                            <small class="text-muted">per <span id="previewUnit">{{ $product->unit }}</span></small>
                        </div>
                        <div id="previewDescription" class="mb-3">
                            <small class="text-muted">{{ Str::limit($product->description, 100, '...') }}</small>
                        </div>
                        <span id="previewStatus" class="badge {{ $product->is_active ? 'bg-success' : 'bg-danger' }}">
                ...
                <div class="hub-card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('products.index') }}" class="hub-btn hub-btn-outline w-100">
