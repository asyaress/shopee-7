...
@section('title', 'Detail Produk - Toedjoe Order System')
        ...
        <div class="col-12 col-lg-6">
            <div class="hub-card">
                ...
                <div class="card-body">
                    ...
                    <form class="mt-3 cost-form" method="POST" action="{{ route('products.update-costs', $product) }}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="hidden" name="hpp_amount" id="hpp_amount" value="{{ $hppVal }}">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        type="text"
                                        class="form-control money-input unit-input rupiah-display {{ $packType === 'percent' ? 'd-none' : '' }}"
                                    ...
                                    <input
                                        type="number"
                                        class="form-control money-input unit-input {{ $packType === 'fixed' ? 'd-none' : '' }}"
                                ...
                                <input type="hidden" name="packaging_value" id="packaging_value" value="{{ $packVal }}">
                                ...
                                <table class="table table-hover mb-0 table-variants">
                                    ...
                                    @foreach($product->variants as $v)
                                        ...
                                        <tr class="variant-row"
                                            ...
                                            <td data-label="Model ID">{{ $v->external_model_id }}</td>
                                            ...
                                            <td data-label="Stok">{{ $v->stock ?? '-' }}</td>

                                            {{-- ✅ Override HPP (Rp only) --}}
                                            ...
                                            {{-- ✅ Override Packaging: (EMPTY=default) / Rp / % --}}
                                            ...
                                            <td data-label="Update"><small class="text-muted">{{ $v->updated_at->diffForHumans() }}</small></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm">
                                <tr>
                                    ...
                                    <td>{{ $product->external_shop_id ?? '-' }}</td>
                                </tr>
                                <tr>
                                    <th>Item ID</th>
                                    <td>{{ $product->external_item_id ?? '-' }}</td>
                                </tr>
                                <tr>
                                    <th>SKU</th>
                    ...
                    @if($product->orders && $product->orders->count() > 0)
                        <div class="table-responsive">
                            <table class="table table-sm table-hover mb-0">
                                ...
                                <tbody>
                                    @foreach($product->orders->take(20) as $o)
                                        <tr>
...
(function () {
  ...
  const PRODUCT_PRICE = Number(@json((float)($product->base_price ?? 0))) || 0;
