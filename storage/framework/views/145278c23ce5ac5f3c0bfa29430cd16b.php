<?php $__env->startSection('title', 'Edit Produk - Toedjoe Order System'); ?>
...
<div class="report-shell hub-form-page">
    <?php echo $__env->make('hub.partials.page-hero', [
        ...
        'actions' => '<a href="' . route('products.show', $product) . '" class="hub-btn hub-btn-outline" style="color:#fff;border-color:rgba(255,255,255,.5)"><i class="fas fa-eye"></i></a>'
            . '<a href="' . route('products.index') . '" class="hub-btn hub-btn-outline" style="color:#fff;border-color:rgba(255,255,255,.5)"><i class="fas fa-arrow-left"></i></a>',
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <form action="<?php echo e(route('products.update', $product->id)); ?>" method="POST" id="productForm">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <option value="pcs" <?php echo e(old('unit', $product->unit) == 'pcs' ? 'selected' : ''); ?>>Pcs (Pieces)</option>
                                    <option value="lembar" <?php echo e(old('unit', $product->unit) == 'lembar' ? 'selected' : ''); ?>>Lembar</option>
                                    <option value="meter" <?php echo e(old('unit', $product->unit) == 'meter' ? 'selected' : ''); ?>>Meter</option>
                                    <option value="m2" <?php echo e(old('unit', $product->unit) == 'm2' ? 'selected' : ''); ?>>M² (Meter Persegi)</option>
                                    <option value="rim" <?php echo e(old('unit', $product->unit) == 'rim' ? 'selected' : ''); ?>>Rim</option>
                                    <option value="roll" <?php echo e(old('unit', $product->unit) == 'roll' ? 'selected' : ''); ?>>Roll</option>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category); ?>" <?php echo e(old('category', $product->category) == $category ? 'selected' : ''); ?>>
                                                <?php echo e($category); ?>
...
unset($__errorArgs, $__bag); ?>"
                                      rows="4"
                                      placeholder="Deskripsikan produk ini, termasuk bahan, ukuran, atau spesifikasi lainnya..."><?php echo e(old('description', $product->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                      rows="3"
                                      placeholder="Contoh: Bahan art paper 120gsm, ukuran A4, finishing glossy/matt..."><?php echo e(old('specifications', $product->specifications)); ?></textarea>
            ...
            <div class="col-lg-4">
                ...
                <div class="hub-card mb-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        <h5 id="previewName" class="mb-1"><?php echo e($product->name); ?></h5>
                        <p id="previewCategory" class="text-muted mb-2" style="<?php echo e($product->category ? '' : 'display: none;'); ?>">
                            <span class="badge bg-info" id="categoryBadge"><?php echo e($product->category); ?></span>
                        </p>
                        <div id="previewPrice" class="mb-3">
                            ...
                            <small class="text-muted">per <span id="previewUnit"><?php echo e($product->unit); ?></span></small>
                        </div>
                        <div id="previewDescription" class="mb-3">
                            <small class="text-muted"><?php echo e(Str::limit($product->description, 100, '...')); ?></small>
                        </div>
                        <span id="previewStatus" class="badge <?php echo e($product->is_active ? 'bg-success' : 'bg-danger'); ?>">
                            <?php echo e($product->is_active ? 'Aktif' : 'Tidak Aktif'); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.hub', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\A. SHOPEE-7\resources\views\products\edit.blade.php ENDPATH**/ ?>