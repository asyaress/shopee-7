<?php $__env->startSection('title', 'Dashboard - Toedjoe Order System'); ?>
...
<div class="report-shell">
    ...
    <div class="report-kpi-hero">
        <div class="report-kpi-card"><div class="label">Total Pesanan</div><div class="value"><?php echo e(hub_num($stats['total_orders'])); ?></div></div>
        <div class="report-kpi-card"><div class="label">Hari Ini</div><div class="value"><?php echo e(hub_num($stats['today_orders'])); ?></div></div>
        <div class="report-kpi-card warn"><div class="label">Sedang Proses</div><div class="value"><?php echo e(hub_num($stats['pending_orders'])); ?></div></div>
        <div class="report-kpi-card"><div class="label">Customer</div><div class="value"><?php echo e(hub_num($stats['total_customers'])); ?></div></div>
    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <a href="<?php echo e(route('orders.create')); ?>" class="hub-btn hub-btn-primary w-100 py-3 quick-action-btn">
                            ...
                            <div class="col-md-3 mb-3">
                                <a href="<?php echo e(route('orders.index')); ?>" class="hub-btn hub-btn-primary w-100 py-3 quick-action-btn">
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-select" id="yearFilter">
                                    <?php for($year = date('Y'); $year >= 2020; $year--): ?>
                                        <option value="<?php echo e($year); ?>" <?php echo e($year == date('Y') ? 'selected' : ''); ?>><?php echo e($year); ?>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="d-flex align-items-center p-3 rounded top-customer-card">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="mb-1"><?php echo e($customer->customer_name ?? $customer->name); ?></h6>
                                            <small class="text-muted">
                                                <?php echo e($customer->orders_count); ?> pesanan
                                            </small>
                                        </div>
                                        <div class="text-end">
            ...
            <div class="col-12">
                <div class="hub-card">
                    <div class="hub-card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('orders.index')); ?>" class="btn btn-sm"
                                ...
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td class="ps-4">
                                                    <strong style="color: var(--primary-red);"><?php echo e($order->order_number); ?></strong>
                                                </td>
                                                <td>
                                                        ...
                                                        <ul class="mb-0 ps-3">
                                                            <?php $__currentLoopData = $order->orderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <li>
                                                                    ...
                                                                    <span class="text-muted small">x<?php echo e($item->quantity); ?></span>
                                                                </li>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="badge bg-<?php echo e($statusColors[$order->status] ?? 'secondary'); ?>">
                                                        <?php echo e($order->status_indonesian ?? ucfirst($order->status)); ?>

                                                    </span>
                                                </td>
                                                <td>
                                                    <div><?php echo e(\Carbon\Carbon::parse($order->order_date)->format('d M Y')); ?></div>
                                                    <small
                                                        class="text-muted"><?php echo e(\Carbon\Carbon::parse($order->order_date)->diffForHumans()); ?></small>
                                                </td>
                                                <td>
                                                    <?php if($order->jenis_pengiriman): ?>
                                                        <span class="badge bg-info"><?php echo e($order->jenis_pengiriman); ?></span>
                                                    <?php else: ?>
                                                        <span class="text-muted">-</span>
                                                    <?php endif; ?>
                                                </td>
<td>
    <?php if($order->jenis_transaksi): ?>
        <span class="badge"
            style="background: <?php echo e($order->jenis_transaksi === 'Shopee' ? 'var(--maroon-600)' : 'var(--maroon-400)'); ?>; color: #fff;">
            <?php echo e($order->jenis_transaksi); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        function applyFilters() {
            ...
            fetch(`<?php echo e(route('dashboard.chart-data')); ?>?${chartParams}`)
            ...
            fetch(`<?php echo e(route('dashboard.product-chart-data')); ?>?${productParams}`)
                .then(response => response.json())
                .then(res => {
            ...
            fetch(`<?php echo e(route('dashboard.weekly-analysis')); ?>?${weeklyParams}`)
                .then(response => response.json())
                .then(res => {
            ...
            if (month || (startDate && endDate)) {
                ...
                fetch(`<?php echo e(route('dashboard.weekly-in-month-analysis')); ?>?${weeklyInMonthParams}`)
                    .then(response => response.json())
                    .then(res => {
            ...
            fetch(`<?php echo e(route('dashboard.monthly-analysis')); ?>?${monthlyParams}`)
                .then(response => response.json())
                .then(res => {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            renderOrdersChart(<?php echo json_encode($chartData, 15, 512) ?>, 'monthly', initialMeta);
            renderProductsChart(<?php echo json_encode($topProducts, 15, 512) ?>);
            renderWeeklyChart(<?php echo json_encode($weeklyData, 15, 512) ?>);
            renderWeeklyInMonthChart(<?php echo json_encode($weeklyInMonthData, 15, 512) ?>);
            renderMonthlyChart(<?php echo json_encode($monthlyData, 15, 512) ?>);
...
<?php echo $__env->make('layouts.hub', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\A. SHOPEE-7\resources\views\dashboard.blade.php ENDPATH**/ ?>