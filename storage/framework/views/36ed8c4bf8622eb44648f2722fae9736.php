<?php $__env->startSection('title', 'HPP & Packaging — Shopee Profit Hub'); ?>
...
<div class="report-shell hub-form-page">
  ...
  <div class="report-filter-card mb-3">
    <form class="row g-2 align-items-end" method="GET" action="<?php echo e(route('products.costs')); ?>">
      <div class="col-md-5">
        <label class="hub-form-label">Cari</label>
        <input type="text" class="hub-form-control" name="search" value="<?php echo e(request('search')); ?>" placeholder="Nama produk...">
      </div>
      <div class="col-md-4">
    ...
    <div class="col-12">
      <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="hub-card cost-scope mb-4"
             ...
             data-product-price="<?php echo e($basePrice); ?>">
              ...
              <div>
                <div class="d-flex flex-wrap align-items-center gap-2">
                  ...
                  <?php if($product->category): ?>
                    <span class="badge bg-info"><?php echo e($product->category); ?></span>
                  <?php endif; ?>
                ...
                <div class="text-muted mt-1">
                  ...
                  <?php if($product->base_price): ?>
                    <b style="color: var(--primary-red);">Rp <?php echo e(number_format($product->base_price, 0, ',', '.')); ?></b>
                  <?php else: ?>
                    <span class="text-muted">Harga Custom</span>
                  <?php endif; ?>
                  <span class="mx-2">•</span>
                  <a href="<?php echo e(route('products.show', $product)); ?>" class="text-decoration-none">Detail</a>
                </div>
              </div>
          ...
          <div class="card-body">
            <form class="cost-form" method="POST" action="<?php echo e(route('products.update-costs', $product)); ?>">
              <?php echo csrf_field(); ?>
              ...
              <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                  ...
                  <input type="hidden" name="hpp_amount" class="p-hpp-hidden" value="<?php echo e($hppVal); ?>">
                ...
                <div class="col-12 col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <input
                      type="text"
                      class="form-control money-input unit-input rupiah-display p-pack-fixed <?php echo e($packType==='percent' ? 'd-none' : ''); ?>"
                      inputmode="numeric"
                      autocomplete="off"
                      placeholder="2.000"
                    ...
                    <input
                      type="number"
                      class="form-control money-input unit-input p-pack-percent <?php echo e($packType==='fixed' ? 'd-none' : ''); ?>"
                  ...
                  <input type="hidden" name="packaging_value" class="p-pack-hidden" value="<?php echo e($packVal); ?>">
                    ...
                    <tbody>
                      <?php $__currentLoopData = $product->variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="variant-row"
                            ...
                            data-variant-price="<?php echo e($vPriceFloat !== null ? $vPriceFloat : ''); ?>">

                          <td data-label="Nama"><?php echo e($v->name); ?></td>

                          <td data-label="Harga">
                            <?php if($vPrice !== null): ?>
                              Rp <?php echo e(number_format($vPrice, 0, ',', '.')); ?>
...
<?php echo $__env->make('layouts.hub', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\A. SHOPEE-7\resources\views\products\costs.blade.php ENDPATH**/ ?>