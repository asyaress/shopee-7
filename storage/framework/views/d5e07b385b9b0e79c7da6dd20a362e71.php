<?php $__env->startSection('title', 'Integrasi Shopee — Shopee Profit Hub'); ?>
    ...
    <div class="row g-3">
            ...
            <div class="hub-card h-100">
                ...
                <div class="hub-card-body">
                    ...
                    <table class="report-pl w-100" style="font-size:0.875rem;">
                        <tr><td class="text-muted py-2">Shop ID</td><td class="text-end fw-bold"><?php echo e($token->shop_id); ?></td></tr>
                        <tr><td class="text-muted py-2">Partner ID</td><td class="text-end"><?php echo e($token->partner_id); ?></td></tr>
                        <tr><td class="text-muted py-2">Token diperoleh</td><td class="text-end"><?php echo e(optional($token->obtained_at)->format('d M Y H:i') ?? '—'); ?></td></tr>
                        <tr><td class="text-muted py-2">Kadaluarsa</td><td class="text-end"><?php echo e(optional($token->expire_at)->format('d M Y H:i') ?? '—'); ?></td></tr>
                    </table>
        ...
        <div class="col-lg-7">
            <div class="hub-card h-100">
                ...
                <div class="hub-card-body">
                    <p class="text-muted small">Untuk kontrol lengkap, gunakan halaman <a href="<?php echo e(route('manage.index')); ?>">Kelola Data</a>.</p>
                    <div class="sync-action-grid">
                        <form method="POST" action="<?php echo e(route('shopee.sync')); ?>" class="sync-action-card">
                            <?php echo csrf_field(); ?>
                            <i class="fas fa-shopping-cart"></i><strong>Order</strong>
                            <input type="number" name="days" value="7" min="1" max="90" class="hub-form-control hub-form-control-sm mt-1" <?php echo e($token ? '' : 'disabled'); ?>>
                            <button class="hub-btn hub-btn-outline hub-btn-sm w-100 mt-2" <?php echo e($token ? '' : 'disabled'); ?>>Sync</button>
                        </form>
                        <form method="POST" action="<?php echo e(route('shopee.sync-products')); ?>" class="sync-action-card">
                            <?php echo csrf_field(); ?>
                            <i class="fas fa-box"></i><strong>Produk</strong>
                            <input type="number" name="page_size" value="100" min="1" max="100" class="hub-form-control hub-form-control-sm mt-1" <?php echo e($token ? '' : 'disabled'); ?>>
                            <button class="hub-btn hub-btn-outline hub-btn-sm w-100 mt-2" <?php echo e($token ? '' : 'disabled'); ?>>Sync</button>
                        </form>
                        <form method="POST" action="<?php echo e(route('shopee.sync-all')); ?>" class="sync-action-card highlight">
                            <?php echo csrf_field(); ?>
                            <i class="fas fa-rocket"></i><strong>Semua</strong>
                            <span>Order + produk</span>
                            <button class="hub-btn hub-btn-primary hub-btn-sm w-100 mt-2" <?php echo e($token ? '' : 'disabled'); ?>>Sync ALL</button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.hub', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\A. SHOPEE-7\resources\views\shopee\index.blade.php ENDPATH**/ ?>