<?php $__env->startSection('title', 'Edit Customer — Shopee Profit Hub'); ?>
...
<div class="report-shell hub-form-page">
    ...
    <form action="<?php echo e(route('customers.update', $customer)); ?>" method="POST" id="customerForm">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('name', $customer->name)); ?>" placeholder="Masukkan nama lengkap"
                                        required>
...
unset($__errorArgs, $__bag); ?>"
                                        required>
                                        <option value="individual" <?php echo e(old('type', $customer->type) == 'individual' ? 'selected' : ''); ?>>Individual</option>
                                        <option value="company" <?php echo e(old('type', $customer->type) == 'company' ? 'selected' : ''); ?>>Perusahaan</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('phone', $customer->phone)); ?>" placeholder="Contoh: 081234567890">
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('email', $customer->email)); ?>" placeholder="customer@email.com">
...
unset($__errorArgs, $__bag); ?>" rows="4"
                                    placeholder="Masukkan alamat lengkap customer..."><?php echo e(old('address', $customer->address)); ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_active" value="1"
                                        id="is_active" <?php echo e(old('is_active', $customer->is_active) ? 'checked' : ''); ?>>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="hub-card mb-4">
                        ...
                        <div class="card-body">
                            <div class="text-center mb-3">
                                <div class="avatar mx-auto mb-2">
                                    <div class="rounded-circle d-flex align-items-center justify-content-center mx-auto"
                                        ...
                                        <i
                                            class="fas fa-<?php echo e($customer->type == 'company' ? 'building' : 'user'); ?> fa-lg"></i>
                                    </div>
                                </div>
                                <h6 class="mb-1"><?php echo e($customer->name); ?></h6>
                            ...
                            <div class="mb-2">
                                ...
                                <span class="badge bg-primary ms-2"><?php echo e($ordersCount); ?></span>
                            </div>
                    ...
                    <div class="hub-card mb-4">
                        ...
                        <div class="card-body text-center">
                            ...
                            <h5 id="previewName" class="mb-1"><?php echo e($customer->name); ?></h5>
                            <p id="previewCompany" class="text-muted mb-2"
                                style="<?php echo e($customer->company ? '' : 'display: none;'); ?>"><?php echo e($customer->company); ?></p>
                            ...
                            <span id="previewType"
                                class="badge <?php echo e($customer->type == 'company' ? 'bg-info' : 'bg-secondary'); ?>">
                    ...
                    <div class="hub-card">
                        <div class="card-body">
                            ...
                            <a href="<?php echo e(route('customers.show', $customer)); ?>" class="hub-btn hub-btn-outline w-100 mb-2">
...
<?php echo $__env->make('layouts.hub', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\A. SHOPEE-7\resources\views\customers\edit.blade.php ENDPATH**/ ?>