...
<body class="hub-body">
    ...
    <nav class="hub-bottomnav">
        <a href="<?php echo e(route('monitoring.index')); ?>" class="<?php echo e(request()->routeIs('monitoring.*') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('shopee.index')); ?>">
    ...
    <script>
        document.getElementById('hubSidebarToggle')?.addEventListener('click', () => {
            ...
            if (!open) {
                ...
                sb.style.top = '64px';
                sb.style.left = '0';
                sb.style.height = 'calc(100vh - 64px)';
                sb.style.boxShadow = '4px 0 24px rgba(0,0,0,.15)';
            }
        });
